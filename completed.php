...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_GET["order"]) && isset($_POST["confirm"])) {
        ...
        if ($result) {
            ...
            header("location: " . url() . 'completed.php');
            exit();
        }
            ...
            <div class="pt-6 px-4">
                ...
                <?php if (isset($_GET['order']) && $_GET['order']) :
                    ...
                    <div class="w-full bg-white shadow-lg border-2 border-cyan-600 rounded-lg mb-4 p-4 sm:p-6 h-full">
                        ...
                        <a href="<?= url() . 'completed.php' ?>" class="text-cyan-600 hover:text-cyan-700">
                ...
                <?php else : ?>
                    <div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                        <div class="flex justify-between w-full">
                            <h3 class="text-2xl font-bold leading-none text-cyan-600 mb-4">Completed Orders</h3>
                        ...
                        <?php
                        $result = $conn->query("SELECT * FROM `orders` WHERE `status`=4 ORDER BY `id` DESC");
                        $orders = $result->fetch_all(MYSQLI_ASSOC);
