...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $verifyUser = $conn->query("SELECT * FROM users WHERE email='$loginU'");
...
<div class="relative min-h-screen flex ">
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
        <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative" style="background-image: url(https://images.unsplash.com/photo-1579451861283-a2239070aaa9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80);">
          ...
          <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Welcome To Paradise</div>
              ...
              class="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg  text-white bg-blue-500 hover:shadow-lg cursor-pointer transition ease-in duration-300"><img
                ...
                <form class="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <div class="relative">
                        ...
                        <input class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="email" name="email" placeholder="mail@gmail.com" required>
                    </div>
